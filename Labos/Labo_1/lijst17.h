...
// te doen....
	...
	Lijst(Lijstknoopptr<T> && lijstknoopptr); //move constructor
	Lijst(Lijst<T> && lijst); //move constructor
	//Lijst(Lijst<T> const& lijst);
	~Lijst(){};
	
	Lijst & operator=(const Lijst& lijst); //move assignment
	Lijst & operator=(Lijst && lijst); //move assignment
	Lijst & operator=(Lijstknoopptr<T> && lijstknoopptr); //move assignment
	
	
	Lijst & operator=(const Lijst<T>& lijst); //copy assignment
...
Lijst<T>::Lijst(){
	...
	cout << "default constructor wordt gebruikt\n";
...
Lijst<T>::Lijst(const Lijst<T>& lijst){
	...
	cout << "copy constructor wordt gebruikt\n";
	Lijst<T> temp = Lijst<T>();
	Lijst<T> * ander = &lijst;
...
template<class T>
Lijst<T>::Lijst(Lijstknoop<T> &&lijstknoop ){
	
	cout << "move lijstknoop constructor wordt gebruikt\n";
...
template<class T>
Lijst<T>::Lijst(Lijst<T>&& lijst) : std::unique_ptr<Lijstknoop<T>>(std::move(lijst)){}



template<class T>
Lijst<T>::Lijst(Lijstknoopptr<T> && lijstknoopptr){
	
	cout << "move lijstknoopptr constructor wordt gebruikt\n";
	
}

	
template<class T>
Lijst<T> & Lijst<T>::operator=(const Lijst& lijst){
	
	cout << "move assignment lijst1 wordt gebruikt\n";
	
}
template<class T>
Lijst<T> & Lijst<T>::operator=(Lijst && lijst){
	
	cout << "move assignment lijst2 wordt gebruikt\n";
...
template<class T>
Lijst<T> & Lijst<T>::operator=(Lijstknoopptr<T> && lijstknoopptr){
	
	cout << "move assignment lijstknoopptr wordt gebruikt\n";
	//Inheritance & casting
...
Lijst<T>& Lijst<T>::operator=(const Lijst<T>& lijst){
	...
	Lijst<T> temp = std:unique_ptr<Lijstknoop<T>>();
	//copy swap techniek
	Lijst<T> temp(lijst);
...
void Lijst<T>::voegToe(const T& sleutel){
	cout << "de sleutel is " << sleutel << endl;
